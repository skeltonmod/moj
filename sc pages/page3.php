...
<head>
  <php>
  <head>
  <title>SB | Standing Committee | Municipality of Jasaan</title>
  <meta charset="utf-8">
  ...
  <link href="../layout/styles/flipcard.css" rel="stylesheet" type="text/css">
  <link href="../layout/styles/vl.css" rel="stylesheet" type="text/css">
        ...
        <ul class="clear">
          ...
          <li class="active"><a class="drop" href="#">ABOUT US</a>
             <ul>
              ...
              <li class="active"><a href="../pages/sc.php">STANDING COMMITTEE</a></li>
    ...
    <main class="hoc container clear"> 
      ...
      <div class="content"> 
        <div id="topbar" class="hoc clear">     
          <center>
            <div class="content"> 
            <img src="../images/sc3a.png" >
         </center> </div>
         <div class="clear">
          <div class="center">
            <ul class="pagination">
              <li><a href="../sc pages/page2.php">«</a></li>
              <li><a href="../pages/sc.php">1</a></li>
              <li><a href="../sc pages/page2.php">2</a></li>
              <li><a class="active"  href="../sc pages/page3.php">3</a></li>
              <li><a href="">»</a></li>
            </ul>
          </div>
        </div>
            ...
            <ul>
              ...
              <li><a>About Us</a>
                <ul>
                  ...
                  <li><a href="../pages/gallery.php">Gallery</a></li>
                  <li><a href="../pages/sb-member.php">SB Members</a></li>
                  <li><a class="active" href="../pages/sc.php">Standing Committee</a></li>
                </ul>
              </li>
            </ul>
          </nav>
