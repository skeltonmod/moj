...
<html lang="en-US">
<head>
<title>SB | Municipal Ordinances | Municipality of Jasaan</title>
<meta charset="utf-8">
...
<link href="../layout/styles/pagination.css" rel="stylesheet" type="text/css" media="all">
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.js"></script>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.3/css/bootstrap.min.css" integrity="sha384-Zug+QiDoJOrZ5t4lssLdxGhVrurbmBWopoEl+M6BdEfwnCJZtKxi1KgxUyJq13dy" crossorigin="anonymous">
    <link rel="stylesheet" href="https://unpkg.com/placeholder-loading/dist/css/placeholder-loading.min.css">

</head>
<body id="top" style="background-image:url('../images/hall3.png'); background-size: cover; background-repeat: no-repeat; ">
   <!-- ################################################################################################ -->
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="#">GOVERNMENT</a>
          <ul>
            <li class="active"><a href="municipal-ordinances.php">MUNICIPAL ORDINANCES</a></li>
...
<div class="wrapper row3" >
  <main class="hoc container clear" > 
    ...
    <div id="topbar" class="hoc clear"> 
      ...
      <div class="card">
        <div class="card-header">APPROVED MUNICIPAL ORDINANCE</div>
        <div class="card-body">
