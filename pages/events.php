...
<body id="top" style="background-image:url('../images/hall3.png'); background-size: cover;">
  ...
  </div><div class="wrapper row6"></div>
  <!-- ################################################################################################ -->
      ...
      <div class="wrapper row7">
        <div class="hoc clear"> 
          <div id="breadcrumb" class="clearfix" style="text-align:justify;">
            <img class="imgl borderedbox inspace-5" src="../images/tempra.jpg" alt="tempra" ><br>
            <address><b><a>Watch out for the grand homecoming of our new Miss Kuyamis 2021, Ms. Dannah Joy Tempra.</a></address></b>Monday, 11<sup>th</sup> January 2021 | </time>
            <p>This coming Monday, January 11, 2021 at 7:30am in the morning there will be a caravan around the town's coastal area right after the program. Together, let us show our support and gratitude to our new QUEEN as she grace the whole province of Misamis Oriental with her charm and beauty. </p>
            <p>Also, we would like to invite everyone to watch the interview of our Hon. Mayor Redentor S. Jardin together with the Secretary for the Presidential Communications Operations Office, Sec. Martin Andanar on PTV4 Channel this coming monday, 9am in the morning.</p>
            <p>Thank you. And see you, Jasaanons.Stay safe always.</p>            
          </div> 
    ...
    <div class="sidebar one_quarter"> 
      ...
      <nav class="sdb_holder">
        <ul>
          ...
          <li><a>Services</a>
            <ul>
              <li><a class="active" href="../pages/events.php">Events</a></li>
