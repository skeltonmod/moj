...
<html lang="eng">
<head>
<title>SB | Committee Reports</title>
<meta charset="utf-8">
      ...
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="#">GOVERNMENT</a>
          <ul>
            ...
            <li class="active"><a href="committee-reports.php">COMMITTEE REPORTS</a></li>
          </ul>
        </li>
  ...
  <main class="hoc container clear" > 
    ...
    <div id="topbar" class="hoc clear"> 
      ...
      <div id="table" class="card">
          ...
          <div class="fl_left">
            <h1>APPROVED COMMITTEE REPORTS</h1>
          </div>
        ...
        <ul>
          ...
          <li><a>Government</a>
            <ul>
              ...
              <li><a class="active" href="../pages/committee-reports.php">Committee Reports</a></li>
            </ul>
          </li>
          <li><a>Services</a>
            <ul>
