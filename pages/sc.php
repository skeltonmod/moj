...
<html lang="eng">
<head>
<title>SB | Standing Committee</title>
<meta charset="utf-8">
      ...
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="#">ABOUT US</a>
           <ul>
            ...
            <li class="active"><a href="sc.php">STANDING COMMITTEE</a></li>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <div id="topbar" class="hoc clear">  
        <center>
           <div class="content"> 
           <img src="../images/sc1a.png">
        </center> </div>
        <div class="clear">
        <div class="center">
          <ul class="pagination">
            <li><a href="">«</a></li>
            <li><a class="active" href="../pages/sc.php">1</a></li>
            <li><a href="../sc pages/page2.php">2</a></li>
            <li><a href="../sc pages/page3.php">3</a></li>
